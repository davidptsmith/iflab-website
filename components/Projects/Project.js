...
export default function Project({ project }) {
  return (
    <div className="  overflow-hidden  rounded-lg shadow-xl hover:shadow-2xl transition duration-500 ease-in-out transform   hover:shadow-xl  transition duration-500 ease-in-out  hover:scale-105 ">

      <a href={`/Projects/${project.slug}`} className="">

        <img alt="iflab Project Image" className="max-h-full h-32 md:h-72  min-w-full align-bottom object-cover opacity-90" src={project.frontmatter.cover_image} />
