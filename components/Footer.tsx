      ...
      <footer className="bg-white  w-full py-12">
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="pt-8 flex max-w-xs mx-auto items-center justify-between">
            ...
            <a
              href="#"
              className="text-gray-300 hover:text-blue-300  transition-colors cursor-pointer duration-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
                fill="currentColor"
                className="text-xl hover:text-blue-300 e transition-colors duration-200"
                viewBox="0 0 16 16"
              >
