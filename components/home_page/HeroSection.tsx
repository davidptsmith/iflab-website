      ...
      <div className="relative  overflow-hidden">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            ...
            src="https://firebasestorage.googleapis.com/v0/b/iflab-website-test1.appspot.com/o/Ravensthrope%2F210224_Ravy_presentation_2%20-%20Photo.jpg?alt=media&token=d626b819-0882-493c-aaff-8d7b5a55466f"
            alt=""
          />
        </div>
      </div>
