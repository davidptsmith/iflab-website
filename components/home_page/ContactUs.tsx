  ...
  return (
    <div className="  min-h-[640px] xl:px-4  w-10/12 md:w-3/4  mx-auto z-10 grid grid-cols-1 gap-4  md:gap-12 xl:grid-cols-2">
      <div className="w-full xl:h-full h-full max-h-screen  overflow-hidden m-auto">
        <img
          className="object-cover xl:h-full w-full  h-72 md:h-full max-h-[640] "
          src="/images/HomePageImages/05_ifLab_Public_Art_Precinct.jpg"
          alt={AltTextFromImage("05_ifLab_Public_Art_Precinct")}
        />
      </div>

      <div className="xl:w-2/3 md:my-auto  xl:ml-16 xl:mt-12 h-full flex">
