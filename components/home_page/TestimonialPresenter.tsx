...
const TestimonialPresenter = () => {
    return (
        <div>
            <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 w-10/12 py-12">
                <div className="w-full text-center pb-8">
                    ...
                    <p className="text-gray-400 font-normal text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
                <div className="w-full grid grid-cols-1 lg:grid-cols-2  gap-2 sm:gap-6">
