 ...
 */}
      ...
      <div className="m-auto">
        <div className=" px-4 pt-14 m-auto h-full ">
          <div className="mx-auto max-w-6xl flex flex-col md:flex-row   my-auto h-full">
            
          <h1 className="">
                We ask <b className="underline">What if</b> we could change
                future by changing building?
              </h1>
            <dl className="w-full h-full my-auto md:w-2/3">
              <dt className="mb-2">
                <h3 className="text-xl font-semibold"> We are <b>IMPACTFUL.</b></h3>
              </dt>
              <dd className="mb-8">
                <p>
                - Acknowledging the potential for positive change
                  through design.
                </p>
              </dd>
              <dt className="mb-2">
                <h3 className="text-xl font-semibold">  We are <b>ETHICAL.</b></h3>
              </dt>
              <dd className="mb-8">
                <p>
              ...
              <dt className="mb-2">
                <h3 className="text-xl font-semibold">  We are <b>DEFIANT.</b></h3>
              </dt>
              <dd className="mb-8">
                <p>
                - Challenging the status quo and always searching for a
      ...
      {/* 
              ...
              <div className=" text-lg font-light">
                <p>
                  ...
                  <br />- Acknowledging the potential for positive change
                  through design.
                </p>
                <p>
                  <span className="text-2xl font-semibold">
                ...
                <p>
                  ...
                  <br />- Challenging the status quo and always searching for a
                  better process and outcome.
                </p>
              </div> */}
      <br className="hidden lg:visible" />
