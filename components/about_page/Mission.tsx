    ...
    return (
       <div className="   prose  lg:py-24 py-12 w-10/12  m-auto">
            ...
            <div className="  container h-full  my-auto m-auto">
                ...
                <p>
                    See how we are align with our mission through our projects, research, or get in contact if you wish to see how we can work together to change the way we build.
                </p>

                <div className="flex flex-row flex-wrap justify-items-center content-center gap-8 mt-8 my-auto mx-auto">

                    <button className="mx-auto px-8 py-2 rounded-md border shadow-sm hover:shadow-xl  transition duration-500 ease-in-out "  >
                        Projects
                    </button >
                    <button className="mx-auto px-8 py-2 rounded-md border shadow-sm hover:shadow-xl  transition duration-500 ease-in-out "  >
                        Insights
